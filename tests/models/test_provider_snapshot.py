...
from apache_buildish_site_pipeline.models.loading import DocumentValidationFailure, load_provider_snapshot
...
class ProviderSnapshotTests(unittest.TestCase):
    ...
    def test_loads_valid_provider_snapshot(self) -> None:
        ...
        self.assertIsInstance(snapshot, ProviderSnapshotV1)
