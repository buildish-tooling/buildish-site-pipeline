...
MODEL_SECTION_DEFINITIONS = (
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_site_pipeline.models.authored.",),
    ),
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_site_pipeline.models.provider.",),
    ),
    ModelSectionDefinition(
    ...
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_site_pipeline.models.emitted.staged_front_matter",),
    ),
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_site_pipeline.models.emitted.aggregates",),
    ),
    ModelSectionDefinition(
        ...
        module_prefixes=(
            "buildish_site_pipeline.staging.incremental_metadata",
            "buildish_site_pipeline.staging.worker_protocol",
        ),
    ),
)
