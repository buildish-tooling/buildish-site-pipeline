                ...
                "component": {
                    ...
                    "publication": {
                        ...
                        "paths": {
                            ...
                            "docs": "/spark/development/docs/",
                            "assets": "/spark/development/assets/",
                        },
                        "urls": {
                            "component": "https://docs.example.org/spark/",
                            "development": "https://docs.example.org/spark/development/",
                            "docs": "https://docs.example.org/spark/development/docs/",
                            "assets": "https://docs.example.org/spark/development/assets/",
                        },
                    },
                },
                "page": {
                    "kind": "docsPage",
                    "artifactKey": "runtime",
                    "path": "/spark/development/docs/sql/",
                    "url": "https://docs.example.org/spark/development/docs/sql/",
                    "canonicalUrl": "https://docs.example.org/spark/development/docs/sql/",
                    "alternateUrls": ["https://docs.example.org/spark/latest/docs/sql/"],
                    "translationKey": "runtime-sql-overview",
                    "translations": [
                        {
                            "locale": "de",
                            "url": "https://docs.example.org/de/spark/development/docs/sql/",
                        },
                    ],
                    "componentPath": "/spark/",
