...
Assessments of severity, advisory status, and CVE candidacy are non-authoritative
triage estimates. Do not infer them from `docs/reference/threat-model.md` alone.
